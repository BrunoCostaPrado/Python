...
print("Conexão bem sucedida. Diretorio atutal de trabalho:",ftp.pwd())
...
while menu=='1' or menu=='2' or menu=='3':
    ...
    if menu=='1':
        ...
        tipo=input("Digite <B> para arquivo binário ou qualquer outra letra para arqvuio ASCII: ").upper()
    if tipo=="B":
